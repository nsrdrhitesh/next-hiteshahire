...
import BlogTable from "../components/PlatformTable";
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        // description="Create, edit, and manage your platforms"
        breadcrumbItems={[
        ...
        createButton={{
          href: "/admin/dashboard/settings/platforms/create",
          label: "Create Platform",
          permission: { resource: "platforms", action: "create" }
        }}
