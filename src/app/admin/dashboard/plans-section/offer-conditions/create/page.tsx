...
export default function CreateOfferConditionPage() {
  ...
  const resetForm = () => {
    setFormData({
      ...
      casteIds: [],
      motherTongueIds: [],
      minAnnualIncomeId: null,
      maxAnnualIncomeId: null,
      minWealthId: null,
      maxWealthId: null,
      nri: false,
      applicablePlanIds: [],
      ...
      planStartTimeAfterApproval: null,
      planEndTimeAfterApproval: null,
      timespanRegApprovalGt: null,
      timespanRegApprovalLt: null,
      planStartDate: "",
      planEndDate: "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/offer-conditions`, {
        method: "POST",
        headers: {
          Authorization: `Bearer ${accessToken}`,
      ...
      await showSuccess("Offer condition created successfully");
    ...
    <div className="space-y-6">
      ...
      {/* <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          />
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Create New Offer Condition</h1>
          <p className="mt-2 text-gray-600 dark:text-gray-400">Define eligibility rules for offers and discounts</p>
        </div>
        <div className="flex gap-2">
          ...
          >
            {isLoading ? "Creating..." : "Create Condition"}
          </button>
        </div>
      </div> */}
      <PageHeader
        title="Create New Offer Condition"
        description="Define eligibility rules for offers and discounts"
        breadcrumbItems={[
          { label: "Dashboard", href: "/admin/dashboard" },
          { label: "Plans Section", href: "/admin/dashboard/plans-section" },
          { label: "Offer Conditions", href: "/admin/dashboard/plans-section/offer-conditions" },
        ...
        actionButtons={[
          ...
          {
            label: isLoading ? "Creating..." : "Create Condition",
            type: "submit",
            form: "condition-form",
            variant: "primary",
            disabled: isLoading,
          ...
          <form id="condition-form" onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="rounded-xl bg-white p-6 shadow-sm dark:bg-gray-800">
              ...
              <div className="mb-4">
                ...
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Select income range limits for eligibility</p>
              </div>
              ...
              <div className="mb-4">
                ...
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Select wealth range limits for eligibility</p>
              </div>
