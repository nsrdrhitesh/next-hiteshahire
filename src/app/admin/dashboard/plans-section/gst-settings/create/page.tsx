...
export default function CreateGstSettingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/gst-settings`, {
        method: "POST",
        headers: {
      ...
      await showSuccess("GST setting created successfully");
      router.push("/admin/dashboard/plans-section/gst-settings");
      router.refresh();
    } catch (err: any) {
      setError(err instanceof Error ? err.message : "Failed to create GST setting");
    ...
    <div className="space-y-6">
      ...
      {/* <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          />
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Create New GST Setting</h1>
          <p className="mt-2 text-gray-600 dark:text-gray-400">Add a new GST rate configuration for specific regions</p>
        </div>
        <div className="flex gap-2">
          ...
          >
            {isLoading ? "Creating..." : "Create GST Setting"}
          </button>
        </div>
      </div> */}
      <PageHeader
        title="Create New GST Setting"
        ...
        actionButtons={[
          ...
          {
            label: isLoading ? "Creating..." : "Create GST Setting",
            type: "submit",
            form: "gst-form",
            variant: "primary",
            disabled: isLoading,
