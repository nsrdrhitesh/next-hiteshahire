// D:\Next-Nest\Matrimony\frontend-repo\src\app\admin\dashboard\domain-manage\push-notifications\page.tsx
"use client";
...
export default function PushNotificationsIndex() {
  ...
  const fetchStats = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${API_URL}/scheduled-campaigns/push-notifications/stats/${selectedPlatformId}`,
  ...
  const fetchNotifications = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${API_URL}/scheduled-campaigns/push-notifications/${selectedPlatformId}?${params}`,
        { 
          headers: { 
      ...
      showError("Failed to load push notifications");
      setNotifications([]);
      setTotalPages(1);
      setTotal(0);
    } finally {
  ...
  }, [fetchNotifications, fetchStats, selectedPlatformId]);
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${API_URL}/scheduled-campaigns/push-notifications/${selectedId}`,
        { 
          method: "DELETE", 
          headers: { 
            Authorization: `Bearer ${token}`,
      ...
      await showSuccess("Push notification deleted successfully");
      ...
      <div className="flex items-center justify-center rounded-xl bg-white p-12 shadow-sm dark:bg-gray-800">
        <div className="text-center">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Please select a platform from the dashboard to manage push notifications.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        // description="Manage push notification templates for automated campaigns"
        breadcrumbItems={[
        ...
        createButton={{
          href: "/admin/dashboard/scheduled-campaigns/push-notification/create",
          label: "Create Notification",
          permission: { resource: "push-notification", action: "create" }
        }}
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-2xl font-bold text-blue-600 dark:text-blue-400">
                {notifications.filter(n => n.nImage).length}
              </p>
            </div>
        ...
        <div className="rounded-xl bg-white p-6 shadow-sm dark:bg-gray-800">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400">With Actions</p>
        ...
        {loading && notifications.length === 0 ? (
          ...
          <div className="py-12 text-center">
            <div className="mx-auto max-w-md">
              ...
              {hasPermission("push-notification", "create") && !searchTerm && (
                <div className="mt-6">
                  <Link
                    href="/admin/dashboard/scheduled-campaigns/push-notification/create"
              ...
              <table className="w-full min-w-max">
                <thead className="border-b border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-900/50">
                  <tr>
                    ...
                    {(hasPermission("push-notification", "view") ||
                      hasPermission("push-notification", "edit") ||
                      hasPermission("push-notification", "delete")) && (
                      <th className="px-6 py-4 text-left text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">
                        Actions
                      </th>
                    )}
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                              Scheduler: {notification.schedulerId} | Route: {notification.routeId}
                            </p>
                          </div>
                        </div>
                      </td>
                      ...
                      {(hasPermission("push-notification", "view") ||
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-2">
                            {hasPermission("push-notification", "view") && (
                              <Link
                                href={`/admin/dashboard/scheduled-campaigns/push-notification/view/${notification.id}`}
                            ...
                            {hasPermission("push-notification", "edit") && (
                              <Link
                                href={`/admin/dashboard/scheduled-campaigns/push-notification/edit/${notification.id}`}
