...
import DomainBrandingTable from "../components/DomainBrandingTable";
...
export default function DomainBrandingPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <PageHeader
        title="Domain Branding Management"
        // description="Customize logos, colors, fonts and branding per platform"
        breadcrumbItems={[
        ...
        createButton={{
          href: "/admin/dashboard/domain-manage/branding/create",
          label: "Create New Branding",
          permission: { resource: "domain-branding", action: "create" }
        }}
          ...
          <div className="flex-1">
            <div className="relative max-w-md">
              ...
              <input
                ...
                placeholder="Search by site name or platform ID..."
      ...
      <DomainBrandingTable searchTerm={searchTerm} />
    </div>
  );
}