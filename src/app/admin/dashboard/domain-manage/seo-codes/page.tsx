...
import DomainSeoCodesTable from "../components/DomainSeoCodesTable";
...
export default function DomainSeoCodesPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <PageHeader
        title="Domain SEO Codes Management"
        // description="Manage tracking pixels, Google Tag Manager, Analytics, Snapchat, Clarity etc."
        breadcrumbItems={[
        ...
        createButton={{
          href: "/admin/dashboard/domain-manage/seo-codes/create",
          label: "Add New Code",
          permission: { resource: "domain-seo-codes", action: "create" }
        }}
          ...
          <div className="flex-1">
            <div className="relative max-w-md">
              ...
              <input
                ...
                placeholder="Search by code snippet or account type..."
      ...
      <DomainSeoCodesTable searchTerm={searchTerm} />
    </div>
  );
}